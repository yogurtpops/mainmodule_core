...
import src.com.google.android.vending.licensing.util.Base64;
import src.com.google.android.vending.licensing.util.Base64DecoderException;
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                ...
                try {
                    Intent intent = new Intent("src.com.google.android.vending.licensing"
//                                            new String(
